...
func makeGetUserListHandler(m *http.ServeMux, endpoints endpoint.Endpoints, options []http1.ServerOption) {
	m.Handle("/get-user-list", http1.NewServer(endpoints.GetUserListEndpoint, decodeGetUserListRequest, encodeGetUserListResponse, options...))
}
...
func encodeGetUserListResponse(ctx context.Context, w http.ResponseWriter, response interface{}) (err error) {
